...
import com.practical.practical_bulletin_board_project.domain.QArticleComment;
        ...
        QuerydslBinderCustomizer<QArticleComment>
{
    ...
    default void customize(QuerydslBindings bindings, QArticleComment root) {
        ...
        bindings.bind(root.content).first(StringExpression::containsIgnoreCase); //쿼리 생성 시 like '%${v}%' - 와일드카드
